...
<div class="list-wrapper">
	<h4>
		...
		printf( esc_html__( 'Exclude specific %1$s', 'sharethis-reaction-buttons' ), esc_html( $type['multi'] ) );
		?>
	</h4>
	<input id="<?php echo esc_attr( $type['single'] ); ?>-ta" type="text" placeholder="
	<?php
		// translators: The list type singular.
		printf( esc_html__( 'Search for a %1$s', 'sharethis-reaction-buttons' ), esc_html( $type['single'] ) );
	?>
